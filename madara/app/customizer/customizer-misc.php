    ...
    $wp_customize->add_control(
        new WP_Customize_Control(
            ...
            array(
                ...
                'type'           => 'text',
                'description' => esc_html__( 'Default Heading Icon in some heading position. Default is "ion-ios-star"', 'madara' ) . '<br/><a href="http://ionicons.com/" target="_blank">' . esc_html__( 'IonIcons', 'madara' ) . '</a><br/><a href="http://fontawesome.io/icons/" target="_blank">' . esc_html__( 'FontAwesome', 'madara' ) . '</a>',
            )
        )
    );
