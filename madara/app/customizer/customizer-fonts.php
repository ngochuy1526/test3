    ...
    $wp_customize->add_control(
        new WP_Customize_Control(
            ...
            array(
                ...
                'type'           => 'text',
                'description' => esc_html__( 'If the Google Fonts list below does not appear, enter your own Google Fonts API Key here. Please follow the link below to create your Key:', 'madara' ) . '</br><a target="_blank" href="https://developers.google.com/fonts/docs/developer_api">Google Fonts API</a>'
            )
        )
    );
