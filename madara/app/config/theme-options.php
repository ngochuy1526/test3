<?php
	...
	$madara_theme_options = array(
         ...
         * */
			...
			array(
				'id'      => 'body_schema_toggle',
				'label'   => esc_html__( 'Body Schema Toggle', 'madara' ),
				'desc'    => esc_html__( 'Show the Dark/Light Toggle button at bottom. This button will be hidden in Reading page as there is another default button in this page', 'madara' ),
				'std'     => 'off',
				'type'    => 'on-off',
				'section' => 'theme_layout'
			),
